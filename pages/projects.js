...
const projects = () => {
  return (
    <div>
      ...
      <body className="text-black transition-colors duration-1000 bg-gray-400 dark:text-white dark:bg-blueGray-700">
  ...
  <div className="flex-1 mx-auto ">
    <div className="grid gap-4 grid-col-1 lg:grid-col-6 lg:gap-8">
      ...
      <div className="lg:col-start-1 col-span-full lg:col-span-6 ">
        <div
          className="flex flex-wrap p-2 mx-auto bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 xl:py-5 xl:px-5">
          <div className="relative flex flex-wrap w-full px-10 py-32 bg-gray-500 rounded-xl">
            <img alt="gallery"
                 className="absolute inset-0 block object-cover object-center w-full h-full opacity-25 rounded-xl"
                 src="https://images.unsplash.com/photo-1593642531955-b62e17bdaa9c?ixlib=rb-1.2.1&ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80"/>
              <div className="relative z-10 w-full px-0 text-left">
                <h2 className="mb-2 text-4xl font-black tracking-tighter text-cyan-400 lg:text-8xl">
                  Qanda
                </h2>
                <p className="text-2xl font-semibold leading-relaxed tracking-tighter text-white">
                  A platform for your SAAS questions &amp; answers.
                </p>
                <button
                  ...
                  <a href="/"
                    ...
                    Case Study
                    <svg xmlns="http://www.w3.org/2000/svg" className="ml-2" width="20"
      ...
      <div className="lg:col-start-1 col-span-full lg:col-span-3 ">
        <div
          ...
          <div className="relative flex flex-wrap w-full px-10 py-32 bg-gray-500 rounded-xl">
            <img alt="gallery"
                 className="absolute inset-0 block object-cover object-center w-full h-full opacity-25 rounded-xl"
                 src="https://images.unsplash.com/photo-1529653762956-b0a27278529c?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=751&q=80" />
              <div className="relative z-10 w-full px-0 text-left">
                <h2 className="mb-2 text-4xl font-black tracking-tighter text-cyan-400 lg:text-8xl">
                  Piccola
                </h2>
                <p className="text-2xl font-semibold leading-relaxed tracking-tighter text-white">
                  An Android app to mesure your happines.
                </p>
                <button
                  className="px-4 py-2 mt-12 text-gray-900 transition duration-500 ease-in-out transform bg-gray-100 border-2 shadow-2xl focus:ring-4 focus:ring-cyan-500 focus:ring-opacity-50 focus:outline-none dark:bg-gray-900 hover:bg-white dark:hover:bg-white border-cyan-400 hover:border-white dark:text-gray-100 dark:hover:text-gray-900 hover:text-gray-900 rounded-xl xl:mt-4">
      ...
      <div className="lg:col-start-4 col-span-full lg:col-span-3 ">
        <div
          className="flex flex-wrap p-2 mx-auto bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 xl:py-5 xl:px-5">
          <div className="relative flex flex-wrap w-full px-10 py-32 bg-gray-500 rounded-xl">
            <img alt="gallery"
                 className="absolute inset-0 block object-cover object-center w-full h-full opacity-25 rounded-xl"
                 src="https://images.unsplash.com/photo-1519336367661-eba9c1dfa5e9?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1500&q=80"/>
              <div className="relative z-10 w-full px-0 text-left">
                <h2 className="mb-2 text-4xl font-black tracking-tighter text-cyan-400 lg:text-8xl">
                  Wantu
                </h2>
