            ...
            <div x-data="{ open: false }"
              ...
              <nav className="{'flex': open, 'hidden': !open}"
                ...
                <a
                  ...
                  href="/">Home</a>
                <a
                  className="px-4 py-2 mt-2 text-sm font-semibold text-gray-600 transition duration-500 ease-in-out transform bg-transparent rounded-lg dark:text-gray-300 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-100 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
          ...
          <div className="flex-1 mx-auto ">
            <div className="grid gap-4 grid-col-1 lg:grid-col-6 lg:gap-8">
                ...
                <div
                  ...
                  <div className="w-full pt-6 text-left">
                    <h1
                      ...
                      Intelli-Park | Parking made Intelligent
                    </h1>
                ...
                <div
                  ...
                  <div className="z-10 w-full mt-6 text-left">
                    ...
                    <p className="mt-4 text-sm leading-relaxed tracking-tighter text-gray-400">
                      Yes! Docker is hot right! Let's learn Docker with an example of a containerized nodeJS
                      application.
                    ...
                    <p className="mt-4 text-sm leading-relaxed tracking-tighter text-gray-400">
                      A quick guide to all the Dart basics and fundamentals that you need to know for building flutter
                      apps.
                    </p>
                  </div>
                </div>
              ...
              <div className="lg:col-start-1 col-span-full lg:col-span-6 ">
                <div
                  className="flex flex-wrap h-full p-8 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 sm:py-10 lg:px-10 ">
                  <div className="hidden xl:w-1/3 xl:block">
                    <img alt="gallery"
                  ...
                  <div className="w-full text-left xl:w-2/3 lg:p-6">
                    <h1
                      className="mt-auto mb-2 font-sans text-2xl font-black tracking-tighter text-cyan-500">
                      Laravel Development Environment Setup using Docker</h1>
                    <p className="text-sm leading-relaxed text-gray-400">
                      Jan 6, 2021
                    </p>
                    <p className="mt-4 leading-relaxed tracking-tighter text-md dark:text-gray-100">
                      It's 2021, the vaccine seems to be coming soon. In the meantime, I have heard the yells and
                      troubles of my LAMP-stack colleagues. I get it, Folks! How painful can it be to continuously
                      update your machines to be able to work with LAMP Stack, especially when working with Laravel?
                      That Composer dump autoloads, clearing your MAMP or XAMPP servers (too many databases). It's a
                      whole wild-west out there. Well, Docker and I together will solve your problem once and for all.
                    </p>
                    <button
                    ...
                    <div className="border-t dark:border-gray-700">
                      <a
                        ...
                        <img alt="blog" src="http://github.com/shashankbiplav.png"
                             className="flex-shrink-0 object-cover object-center w-12 h-12 rounded-full"/>
                        <span className="flex flex-col flex-grow pl-4">
                                                <span
                                                  className="font-medium text-gray-900 title-font dark:text-gray-100">Shashank Biplav</span>
                                                <span className="text-sm text-gray-500 dark:text-gray-400">Software Engineer / Technology Blogger</span>
                                            </span>
                      </a>
                    </div>
                  </div>
              ...
              <div className="lg:col-start-1 lg:row-span-1 col-span-full lg:col-span-1 ">
                <div
                  ...
                  <div className="w-full pt-6 text-left">
                    <h1
                      className="mt-auto mb-2 font-sans text-2xl font-black tracking-tighter text-cyan-500">
                      NodeJS VS DenoJS! Which one and Why?
                    </h1>
              ...
              <div className="lg:col-start-2 col-span-full lg:col-span-4 ">
                <div
                  ...
                  <div className="w-full text-left xl:w-2/3 lg:p-6">
                    <h1
                      className="mt-auto mb-2 font-sans text-2xl font-black tracking-tighter text-cyan-500">
                      Flutter Development Environment Setup On macOS</h1>
                    <p className="text-sm leading-relaxed text-gray-400">
                      Jul 27, 2020
                    </p>
                    <p className="mt-4 leading-relaxed tracking-tighter text-md dark:text-gray-100">
                    ...
                    <div className="mt-16 border-t dark:border-gray-700">
                      <a
                        className="inline-flex items-center mt-4 focus:ring-4 focus:ring-cyan-500 focus:ring-opacity-50 focus:outline-none">
                        <img alt="blog"
                             src="https://github.com/shashankbiplav.png"
                             className="flex-shrink-0 object-cover object-center w-12 h-12 rounded-full"/>
                        <span className="flex flex-col flex-grow pl-4">
                                                <span
                                                  className="font-medium text-gray-900 title-font dark:text-gray-100">Shashank Biplav</span>
                ...
                <div
                  ...
                  <div className="w-full mx-auto mb-4 text-center xl:w-1/2">
                    <h1
                      ...
                      Shashank Biplav</h1>
                    <p className="text-lg leading-relaxed text-gray-400">Software Engineer &amp; Technology Blogger
                    </p>
                  </div>
                  ...
                  <span className="flex-wrap mx-auto mt-8 text-sm font-bold text-gray-400 licence-text">
