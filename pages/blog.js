...
const blog = () => {
    ...
    <div>
      ...
      <section className="text-gray-700">
        <div className="container px-5 mx-auto lg:py-5 xl:px-0">
          <div className="w-full mt-4 mb-4 text-black bg-gray-100 shadow-xl lg:mb-8 dark:text-white rounded-xl dark:bg-gray-900">
            ...
            <a className="px-4 py-2 mt-2 text-sm font-semibold text-gray-600 transition duration-500 ease-in-out transform bg-transparent rounded-lg dark:text-gray-300 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-300 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
               href="/">Home</a>
            <a className="px-4 py-2 mt-2 text-sm font-semibold text-gray-600 transition duration-500 ease-in-out transform bg-transparent rounded-lg dark:text-gray-300 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-100 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
  ...
  <div className="flex-1 mx-auto ">
    <div className="grid gap-4 grid-col-1 lg:grid-col-6 lg:gap-8">
      <div className="lg:col-start-1 col-span-full lg:row-span-1 ">
        <div className="flex flex-wrap h-full p-8 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 xl:py-5 xl:px-10 ">
          <div className="w-full pt-6 text-left">
            <h1
              ...
              Samsung may have just spilled
            </h1>
            <p className="text-sm leading-relaxed text-gray-400">Nov 27, 2020, 6:55pm EST
            </p>
            <p className="mt-4 leading-relaxed tracking-tighter text-md dark:text-gray-100">
              We kind of loved the beans. The Galaxy Buds Live’s bean-like shape made sense!
              But though it originally seemed like
              Samsung was in on the joke — the company called them beans internally, and even
              printed the word on the circuitry —
              Samsung’s next earbuds may take a take a different tack.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-right text-gray-400 justify-right"> -
              The Fergg
            </p>
          </div>
        </div>
      ...
      <div className="lg:col-start-2 col-span-full lg:col-span-4 ">
        <div className="flex flex-wrap h-full px-2 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 xl:py-10 xl:px-10 ">
          ...
          <div className="w-full p-6 text-left xl:w-2/3">
            ...
            <p className="text-xs leading-relaxed text-gray-400">
              Nov 09, 2020, 6:55pm EST
            </p>
            <p className="mt-12 leading-relaxed tracking-tighter text-md dark:text-gray-100">
              Refers to the appearance of all the text on your website. ... It's the size of
              different runs of text in relation to one
              another, and the history behind each font family. A lot of your typography
              decisions will come from a designer.
            </p>
            <button
              ...
              <a href="./blogpost.html"
                ...
                Read More
                <svg xmlns="http://www.w3.org/2000/svg" className="ml-2" width="20" height="20" viewBox="0 0 24 24"
      ...
      <div className="hidden lg:col-end-7 col-span-full lg:col-span-1 lg:block">
        <div className="flex flex-wrap h-full p-8 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 xl:py-5 xl:px-10 ">
          <div className="z-10 w-full mt-6 text-left">
            <h1
              ...
              Popular Posts</h1>
            <h2
              className="mt-6 mb-2 font-sans text-lg font-black tracking-tighter text-cyan-700 dark:text-cyan-700">
              Web Accessibilty.
            </h2>
            <p className="mt-4 text-sm leading-relaxed tracking-tighter text-gray-400">
              Find colors and typography combinations ready to copy paste in one click.
            </p>
            <hr className="my-4 border dark:border-gray-700" />
              <h2
                className="mt-6 mb-2 font-sans text-lg font-black tracking-tighter text-cyan-700 dark:text-cyan-700">
                UI Animations.
              </h2>
      ...
      <div className="lg:col-start-1 col-span-full lg:col-span-6 ">
        <div className="flex flex-wrap h-full p-8 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 sm:py-10 lg:px-10 ">
          <div className="hidden xl:w-1/3 xl:block">
            <img alt="gallery"
          ...
          <div className="w-full text-left xl:w-2/3 lg:p-6">
            <h1
              className="mt-auto mb-2 font-sans text-2xl font-black tracking-tighter text-cyan-500">
              How to protect humans in an automated society.</h1>
            <p className="text-sm leading-relaxed text-gray-400">
              Nov 27, 2020, 6:55pm EST
            </p>
            <p className="mt-4 leading-relaxed tracking-tighter text-md dark:text-gray-100">
              People have been worried about machines taking jobs for a very long time. As
              early as 1930, John Maynard Keynes was
              warning about the new scourge of technological unemployment, which he termed as
              “unemployment due to our discovery of
              means of economizing the use of labor outrunning the pace at which we can find
              new uses for labor.” In short, automating
            ...
            <div className="border-t dark:border-gray-700">
              <a
                className="inline-flex items-center mt-4 focus:ring-4 focus:ring-cyan-500 focus:ring-opacity-50 focus:outline-none">
                <img alt="blog" src="https://uifaces.co/our-content/donated/Te-0H20q.png"
                     className="flex-shrink-0 object-cover object-center w-12 h-12 rounded-full" />
                                            <span className="flex flex-col flex-grow pl-4">
                                                <span
                                                  className="font-medium text-gray-900 title-font dark:text-gray-100">Somwann
                                                    Fehimus</span>
                                                <span className="text-sm text-gray-500 dark:text-gray-400">The Ferg /
                                                    Rapporter</span>
                                            </span>
              </a>
            </div>
      ...
      <div className="lg:col-start-1 lg:row-span-1 col-span-full lg:col-span-1 ">
        <div
          className="flex flex-wrap h-full px-8 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 sm:py-10 lg:px-10 ">
          <div className="w-full pt-6 text-left">
            <h1
              className="mt-auto mb-2 font-sans text-2xl font-black tracking-tighter text-cyan-500">
            ...
            <p className="mt-4 leading-relaxed tracking-tighter text-md dark:text-gray-100">
              State machines are typically expressed on the web in JavaScript and often through the popular XState library. But the
              concept of a state machine is adaptable to just about any language, including, amazingly, HTML and CSS. In this article,
      ...
      <div className="lg:col-start-2 col-span-full lg:col-span-4 ">
        <div className="flex flex-wrap h-full p-8 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 sm:py-10 lg:px-10 ">
          ...
          <div className="w-full text-left xl:w-2/3 lg:p-6">
            <h1
              className="mt-auto mb-2 font-sans text-2xl font-black tracking-tighter text-cyan-500">
              How to Create a Realistic Motion Blur with CSS Transitions</h1>
            <p className="text-sm leading-relaxed text-gray-400">
              Nov 27, 2020, 6:55pm EST
            </p>
            <p className="mt-4 leading-relaxed tracking-tighter text-md dark:text-gray-100">
              Imagine a camera. It’s got a shutter, a door that opens to let light in, and then closes to stop the light from coming
              in. From the time it opens, to when it closes, is a single photograph, or a single frame of a moving image.
            </p>
            <button
            ...
            <div className="mt-16 border-t dark:border-gray-700">
              <a
                className="inline-flex items-center mt-4 focus:ring-4 focus:ring-cyan-500 focus:ring-opacity-50 focus:outline-none">
                <img alt="blog"
                     ...
                     className="flex-shrink-0 object-cover object-center w-12 h-12 rounded-full" />
                                            <span className="flex flex-col flex-grow pl-4">
                                                <span
                                                  className="font-medium text-gray-900 title-font dark:text-gray-100">Michael
                                                    Andreuzza</span>
                                                <span className="text-sm text-gray-500 dark:text-gray-400">UI Designer /
                                                    Front-End Dev
                                                    Wannabe</span>
                                            </span>
              </a>
      ...
      <div className="lg:col-end-7 col-span-full lg:col-span-1 ">
        <div
          ...
          <div className="w-full pt-6 text-left">
            ...
            <p className="mt-4 leading-relaxed tracking-tighter text-md dark:text-gray-100">
              We kind of loved the beans. The Galaxy Buds Live’s bean-like shape made sense!
              But though it originally
              seemed like
              Samsung was in on the joke — the company called them beans internally, and even
              printed the word on the
              circuitry —
              Samsung’s next earbuds may take a take a different tack.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-right text-gray-400 justify-right"> -
      ...
      <div className="lg:col-start-1 col-span-full lg:col-span-6 ">
        <div
          className="flex flex-wrap w-full h-full px-6 pt-10 mb-4 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-900 sm:py-24 lg:px-10 ">
          <div className="w-full mx-auto mb-4 text-center xl:w-1/2">
            <h1 className="mt-auto mb-2 font-sans text-3xl font-black tracking-tighter xl:text-6xl lg:text-4xl text-cyan-500">
              Michael Andreuzza</h1>
            <p className="text-lg leading-relaxed text-gray-400">UI Designer &amp; Front-End
              Developer
            </p>
          </div>
          <div className="flex flex-wrap justify-start mx-auto text-center ">
            <div className="w-1/3 my-2 lg:p-3 md:w-1/6 lg:mx-auto">
              <button
                ...
                <a href="./blogpost.html" className="focus:outline-none">
              ...
              <a href="./blogpost.html" className="focus:outline-none">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    fill="currentColor" />
                  <path d="M5.5 12C5.5 10.3431 6.84315 9 8.5 9H11.5V15H8.5C6.84315 15 5.5 13.6569 5.5 12Z"
                        fill="currentColor" />
                  <path
        ...
        <span className="flex-wrap mx-auto mt-8 text-sm font-bold text-gray-400 " xmlns="http://purl.org/dc/terms/"
              xmlns="http://creativecommons.org/ns#" className="license-text">
                                    <a className="underline text-cyan-500" rel="cc:attributionURL" property="dct:title"
                                       href="http://wickedtemplates.com/">This Wicked
                                        Template</a>
                                    by
                                    <a className="underline text-cyan-500" rel="cc:attributionURL dct:creator" property="cc:attributionName"
                                       href="https://twitter.com/Mike_Andreuzza">Michael
                                        Andreuzza</a>
                                    is licensed under
                                    <a className="underline text-cyan-500" rel="license" href="https://creativecommons.org/licenses/by-sa/4.0">
                                        CC BY-SA 4.0
                                    </a>
                                </span>
      </div>
